package love.chihuyu.chihuyulib.command

import love.chihuyu.chihuyulib.ChihuyuLib.Companion.chihuyu
...
abstract class Command(private val name: String) : CommandExecutor, TabCompleter {
     ...
     */
    fun register() {
        val command = chihuyu.getCommand(name) ?: throw IllegalStateException()
